...
import { CreateQuestionDto, CreateQuestionOptionDto, UpdateQuestionDto } from './dto/question.dto';
...
export class QuestionController {
    ...
    async create(@Body() createQuestionDto: CreateQuestionDto) {
        ...
        try {
            ...
            if (options) {
                questionInput.options = await this.questionService.createOption(options);
            }
    ...
    async update(
        ...
        try {
            ...
            if (updateQuestionDto.categoryId) {
                updatedQuestion.category = await this.categoryService.findOne(updateQuestionDto.categoryId);
            }
